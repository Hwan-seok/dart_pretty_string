...
mixin _$Member {
  ...
  List<Member> get friends => throw _privateConstructorUsedError;
...
abstract class $MemberCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, List<Member> friends});
}
...
class _$_Member extends _Member {
  const _$_Member(
      {required this.id,
      required this.name,
      required final List<Member> friends})
      : _friends = friends,
        super._();
  ...
  @override
  final String name;
  final List<Member> _friends;
  @override
  List<Member> get friends {
  ...
  @override
  String toString() {
    return 'Member(id: $id, name: $name, friends: $friends)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, const DeepCollectionEquality().hash(_friends));
...
abstract class _Member extends Member {
  const factory _Member(
      ...
      required final List<Member> friends}) = _$_Member;
